...
const contentAbout = `import React from 'react';
...
const contentContact = `import React from 'react';
import Navbar from '@/components/layout/Navbar';
    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-6 py-32 flex flex-col items-center">
        ...
        <div className="max-w-4xl mx-auto space-y-12 text-gray-300 relative z-10 p-6 md:p-12 glass rounded-3xl border border-white/10 bg-black/40 backdrop-blur-md w-full">
          <section className="text-center">
            <p className="text-lg leading-relaxed">
              Have questions about how NEXUS can help you get hired? Let's talk. We're here to help you navigate your career options and make sense of the skills you need.
            </p>
          </section>
...
const contentPrivacy = `import React from 'react';
import Navbar from '@/components/layout/Navbar';
...
fs.writeFileSync('C:/Users/Shash/OneDrive/Desktop/BDA/BigData/src/app/about/page.tsx', contentAbout, 'utf-8');
fs.writeFileSync('C:/Users/Shash/OneDrive/Desktop/BDA/BigData/src/app/contact/page.tsx', contentContact, 'utf-8');
fs.writeFileSync('C:/Users/Shash/OneDrive/Desktop/BDA/BigData/src/app/privacy/page.tsx', contentPrivacy, 'utf-8');

console.log('Successfully recreated completely clean files.');